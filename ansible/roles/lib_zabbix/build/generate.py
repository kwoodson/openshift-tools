#!/usr/bin/env python
'''
  Generate the openshift-tools/ansible/roles/lib_zabbix/library/ modules.
'''
...
FILES = {'zbx_user.py': ['lib/base.py',
                         'lib/zbxapi.py',
                         'lib/user.py',
                         'ansible/zbx_user.py',
                        ],
         'zbx_user_media.py': ['lib/base.py',
                               'lib/zbxapi.py',
                               'lib/media.py',
                               'ansible/zbx_user_media.py',
                              ],
        }
